...
namespace QuickNotes.DataAccess.EF.Context;
...
public partial class QuickNotesContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            var connString = configuration.GetConnectionString("QuickNotesConnection");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.UserRefreshToken)
                .HasMaxLength(70)
                .HasColumnName("User_refresh_token");
            entity.Property(e => e.UserRefreshTokenExpiryTime).HasColumnName("User_refresh_token_expiry_time");
